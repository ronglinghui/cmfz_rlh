    ...
    <script>
        ...
        $(function () {
            ...
            $("#captchaImage").click(function () {
                $("#captchaImage").prop("src", "${pageContext.request.contextPath}/code/execute?time=" + new Date().getTime())
            })
            //异步跳转登录
            $("#loginButtonId").click(function () {
                ...
                if (username == "") {
                    ...
                    if (password == "") {
                        ...
                        //提交数据
                        $.post("${pageContext.request.contextPath}/admin/loginAdmin", "username=" + username + "&password=" + password + "&code=" + code, function (result) {
                            //判断是否返回null
                            if (result == "") {
                                location.href = "${pageContext.request.contextPath}/jsp/zhuye.jsp";
                            } else {
                                //显示错误信息
                                $("#cuwu").text(result)
                            }
                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    <div class="form-top" style="width: 450px">
                        <div class="form-top-left">
                            ...
                            <p>Enter your username and password to log on:<span id="cuwu" style="color: red"></span></p>
                        </div>
                        ...
                        <form role="form" action="" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                <img id="captchaImage" style="height: 41px" class="captchaImage"
                                     src="${pageContext.request.contextPath}/code/execute">
